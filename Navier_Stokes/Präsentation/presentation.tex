...
%----------------------------------------------------------------------------------------
\titlegraphic{\includegraphics[width=0.6\textwidth,height=.5\textheight]{Navier.png}}
\begin{document}
...
\begin{figure}
	\includegraphics[width=1\linewidth]{cylinder_pressure_zoom.png}
...
\begin{frame}
	...
	\end{center}
	\begin{figure}
		\includegraphics[width=0.35\linewidth]{cylinder_visc_cl_cd_graph.png}
